              ...
              {mediaFile ? (
                <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-50">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-2 size-7  bg-slate-900/50 text-white rounded-full flex items-center justify-center transition-colors hover:bg-slate-black-900/80"
                  >
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs bg-emerald-50 text-emerald-700 border-emerald-100 px-2 py-0.5 rounded-full">Published</span>
                    </div>
                  </div>
