                ...
                <div className="relative group mt-12">
                    ...
                    <div className="absolute bottom-4 right-2.5 flex items-center gap-3 text-sm">
                        ...
                        <button onClick={() => setGenerateImage(!generateImage)} className="flex items-center gap-3 bg-red-50 py-2 px-3 rounded-lg">
                            ...
                            >
                                <span
                                    className={`pointer-events-none inline-block size-4 transform translate-y-0.5 rounded-full bg-white transition ${generateImage ? "translate-x-4.5" : "translate-x-0.5"
                                        }`}
                                />
                            </button>
                        </button>
                    ...
                    ))}
                    {
                        generations.length === 0 && (
                            <div className="col-span-full py-20 text-center space-y-2">
                                ...
                                <p className="text-slate-400 text-sm">No cintent generated yet. Try generating some content using the AI.</p>
                            </div>
                        )}
</div>
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
  ...
  <div className="relative">
    <ClockIcon className="w-4 h-4 absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" />
